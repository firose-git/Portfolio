              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    I'm {" "}
                    <AnimatedText
                      texts={["Pursuing MCA", "a Web Developer", "a Python Developer", "a Web Designer"]}
                ...
                <div className="flex gap-4">
                  <Link href="https://github.com/firose-git/" target="_blank" rel="noopener noreferrer">
                    <Button
                      variant="ghost"
                      size="icon"
                  ...
                  <Link href="https://www.linkedin.com/in/md-firose-311518267/" target="_blank" rel="noopener noreferrer">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="rounded-full hover:bg-primary/10 hover:text-primary transition-all duration-300"
                  ...
                  <Link href="https://x.com/FiroseMd786" target="_blank" rel="noopener noreferrer">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="rounded-full hover:bg-primary/10 hover:text-primary transition-all duration-300"
          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-24">
            <div className="text-center mb-16">
              ...
              <p className="max-w-4xl text-lg text-gray-300 mt-4 mx-auto">
                I'm currently pursuing my MCA (Master of Computer Applications) with a strong interest in becoming an innovative Python Developer and Web Developer. I'm passionate about creating innovative and user-centric digital experiences. My goal is to build impactful tech solutions that combine creativity, code, and commitment, bringing ideas to life in the most efficient and engaging way possible.
              </p>
            </div>
              ...
              <div className="space-y-14">
                ...
                <div>
                  ...
                  <ul className="mt-4 text-gray-200 space-y-3 text-sm pl-2">
                    ...
                    <li>
                      <strong>Bachelor of Computer Science - <span className="text-yellow-300">65%</span></strong><br />
                      <span className="text-teal-300">Yadava College, Madurai (2020–2023)</span>
                    </li>
                    <li>
                      <strong>Pre University - <span className="text-yellow-300">63%</span></strong><br />
                      <span className="text-teal-300">Al-Hudha Islamic Matriculation School, Sivaganga (2020)</span>
                    </li>
                    <li>
                      <strong>SSLC - <span className="text-yellow-300">60%</span></strong><br />
                      <span className="text-teal-300">Al-Hudha Islamic Matriculation School, Sivaganga (2018)</span>
                    </li>
                  </ul>
                </div>
...
<div>
  ...
  <ul className="mt-4 text-gray-200 space-y-3 text-sm pl-2">
    ...
    <li>
      ...
      – <span className="text-teal-300">Tech Mindsparc (09/2024)</span>
    </li>
    <li>
      <a
    ...
    <li>
      <a
        ...
        className="no-underline hover:text-yellow-500"
      >
        <strong>Tata Imagination Challenge Participate
</strong>
      </a>{" "}
              ...
              <div className="space-y-14">
                ...
                <div className="bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-700 transition hover:scale-[1.02] duration-300">
                  ...
                  <div className="space-y-3 text-sm md:text-base">
                    ...
                    <div className="flex items-center gap-2"><MdEmail className="text-lg" /> <strong>Email:</strong> <span className="ml-auto">mohamedfirose2312@gmail.com</span></div>
                    <div className="flex items-center gap-2"><MdPhone className="text-lg" /> <strong>Phone:</strong> <span className="ml-auto">+91 90872 51849</span></div>
                    ...
                    <div className="flex items-center gap-2"><MdLocationCity className="text-lg" /> <strong>State:</strong> <span className="ml-auto">Tamilnadu</span></div>
                    <div className="flex items-center gap-2"><MdLocationCity className="text-lg" /> <strong>City:</strong> <span className="ml-auto">Sivaganga</span></div>
                  </div>
                </div>
...
<div>
  ...
  <ul className="mt-4 text-gray-200 space-y-3 text-sm pl-2">
    ...
    <li>
      ...
      <span className="text-teal-300">ML, Data Processing, Model Deployment</span>
    </li>
    <li>
      <a
        ...
        className="no-underline hover:text-yellow-500"
      >
        <strong>Python Full Stack Intern</strong> | Shiash InfoTech
      </a>
      <br />
      <span className="text-yellow-300">May-July 2023</span><br />
      <span className="text-teal-300">Django, MongoDB, APIs, JWT</span>
    </li>
  </ul>
</div>
                ...
                <div>
                  ...
                  <p className="text-gray-300 mt-2">
                    • Photography 📸 • Exploring Tech 💡 • IoT & Raspberry Pi   ⚙️ • Creative Coding 💻
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <ProjectCard
                ...
                tags={["Python", "Flask", "AI", "Chatbot", "Personal Assistant"]}
                  ...
                  <div className="grid gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-4 flex flex-wrap gap-2">
                        ...
                        <SkillBadge name="Flask" icon={<Code className="h-3 w-3" />} />
                        
                        <SkillBadge name="Python" icon={<Code className="h-3 w-3" />} />
                        <SkillBadge name="Django" icon={<Code className="h-3 w-3" />} />
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4 transition-all duration-300 hover:translate-x-1">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Mohamedfirose59@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 transition-all duration-300 hover:translate-x-1">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">https://www.linkedin.com/in/md-firose-311518267/</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 transition-all duration-300 hover:translate-x-1">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">https://github.com/firose-git/</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 transition-all duration-300 hover:translate-x-1">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">https://x.com/FiroseMd786</p>
                  </div>
                </div>
              </div>
              <ContactForm />
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-2">
              ...
              <Link href="https://www.linkedin.com/in/md-firose-311518267/" target="_blank">
                <div className="bg-gray-800 p-3 rounded-full hover:bg-[#0a66c2] transition">
                  <Linkedin className="w-5 h-5" />
                </div>
              </Link>
              <Link href="https://www.instagram.com/mr_2stroke__official/" target="_blank">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-400 text-sm">
              <a href="tel:+919087251849" className="flex items-center gap-3 no-underline text-inherit hover:opacity-80 transition">
                <Phone size={16} className="text-teal-500" />
                <span>+91 90872 51849</span>
              </a>

              <a href="mailto:mohamedfirose2312@gmail.com" className="flex items-center gap-3 no-underline text-inherit hover:opacity-80 transition">
